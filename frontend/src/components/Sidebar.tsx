    ...
    <aside className="fixed left-0 top-0 h-full w-60 bg-white border-r border-slate-100 flex flex-col z-30 shadow-sm">
      ...
      <div className="px-5 py-5 border-b border-slate-100">
        <div className="flex items-center gap-2.5">
          ...
          <div>
            <p className="text-sm font-bold text-slate-900 leading-none">VendorRecon</p>
            <p className="text-[10px] text-slate-400 mt-0.5">AP Reconciliation</p>
          </div>
        </div>
      </div>
      ...
      <div className="px-4 py-4 border-t border-slate-100 space-y-2">
        ...
        <button
          ...
          className="w-full flex items-center gap-2 px-3 py-2 rounded-lg text-xs font-medium text-slate-400 hover:text-red-600 hover:bg-red-50 transition-colors"
        >
        ...
        <div className="flex flex-wrap gap-x-3 gap-y-1 pt-1 px-1">
          ...
          <a href="/cookies" className="text-[10px] text-slate-300 hover:text-slate-500 transition-colors">Cookies</a>
          <a href="/dpa" className="text-[10px] text-slate-300 hover:text-slate-500 transition-colors">DPA</a>
          <a href="/refund" className="text-[10px] text-slate-300 hover:text-slate-500 transition-colors">Refunds</a>
